describe('Add Pay Grade and Currency', () => {
  it('Should add a new pay grade and then add a currency to it', () => {
    ...
    cy.get('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > form > div.oxd-form-row > div > div > div > div:nth-child(2) > input').type('Test Pay Grade');
    // Save the Pay Grade
